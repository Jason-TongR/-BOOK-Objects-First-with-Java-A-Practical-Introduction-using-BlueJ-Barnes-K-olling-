...
public class ImageViewer extends Application
{
    ...
    private void saveAsAction(ActionEvent event)
    {
        if(currentImage != null) {
            ...
            if (file != null) {   // if the dialogue is cancelled, file is null
                ImageFileManager.saveImage(currentImage, file);
                showFilename(file.getPath());
            }
        }
    }
    ...
    private void makeMenuBar(Pane parent)
    {
        ...
        saveAsItem.setOnAction(this::saveAsAction);
        ...
        fileMenu.getItems().addAll(openItem, closeItem, saveAsItem, sep, quitItem);
