...
public class AddressBookTest
{
    ...
    public void setUp()
    {
        ...
        revisedDetails = new ContactDetails(existingContact.name(),
    ...
    {
        assertEquals(existingContact, book.getDetails(existingContact.name()));
        assertNull(book.getDetails(furtherContact.name()));
    }
    ...
    {
        assertEquals(true, book.keyInUse(existingContact.name()));
        assertEquals(true, book.keyInUse(existingContact.phone()));
    }
    ...
    public void testChangeDetails()
    {
        ...
        assertEquals(revisedDetails, book.getDetails(revisedDetails.name()));
    }
    ...
    {
        assertEquals(book.search(existingContact.name()).length, 1);
        assertEquals(book.search(furtherContact.name()).length, 0);
        book.addDetails(furtherContact);
        assertEquals(book.search(furtherContact.name()).length, 1);
    }
